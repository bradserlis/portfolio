...
sr.reveal("#current-project", { duration: 1800 });
sr.reveal(".current-project", { duration: 1500 });
sr.reveal(".appear", { duration: 1500 });
sr.reveal(".current-project-app-name", { duration: 1500 });
...
new TypeIt("#whoami", {
  strings: [
    ...
    "Gamer.",
    "Musician.",
    "<span class='colorful-background'> Full Stack Developer.</span>"
  ],
  speed: 85,
  breakLines: false,
  autoStart: false
